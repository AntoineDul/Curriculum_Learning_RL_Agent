CONFIG = {
    ...
    "goal_move_frequency":5,        # How often goal moves
    "goal_step_size":3,             # Step size for the goal
    ...
    "random_reward_is_moving": True,   # Set static or moving random reward object 
